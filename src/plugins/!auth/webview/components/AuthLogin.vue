...
<template>
    <div class="flex flex-col gap-4">
        ...
        <span class="font-medium text-red-400" v-if="isInvalid">{{ t('auth.span.bad.password') }}</span>
        <input
            type="text"
            ...
            autocomplete="email"
            @input="checkForm"
            class="rounded border border-neutral-300 bg-neutral-100 p-2 outline-none placeholder:text-neutral-300 focus:border-blue-300"
        />
        <input
            type="password"
        ...
        <button
            class="w-full rounded-lg p-2 text-center font-medium"
